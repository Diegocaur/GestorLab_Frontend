...
const ModalFormularioTarea = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    //resetear el state despues de enviar tarea
              ...
              <div className="sm:flex sm:items-start">
                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                  ...
                  <form onSubmit={handleSubmit} action="" className="my-10">
                    ...
                    <input
                      type="submit"
                      className="bg-indigo-400 hover:bg-indigo-500 w-full p-3 text-white uppercase rounded-md font-bold cursor-pointer transition-colors text-sm"
