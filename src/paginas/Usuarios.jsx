...
const Usuarios = () => {
  const { usuarios, cargandoUsuarios } = useProyectos();
  //console.log(usuarios);

  return (
    <div>
      <h1 className=" text-3xl font-bold text-indigo-500  uppercase text-center mb-4 ">
        Usuarios
      </h1>
      {cargandoUsuarios ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
          {usuarios.map((usuario) => (
            ...
            >
              <div className="flex items-center justify-center bg-blue-500 h-16 w-16 rounded-full text-white font-semibold text-lg">
                {
                  usuario.nombre
                    .split(" ") // Dividir el nombre completo en palabras
                    .map((word) => word.charAt(0)) // Obtener la primera letra de cada palabra
                    .slice(0, 3) // Mostrar hasta tres iniciales
